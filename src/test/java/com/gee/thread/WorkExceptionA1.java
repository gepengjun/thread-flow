 ...
 */
public class WorkExceptionA1<V> extends AbstractWork<V, String,String> {
    ...
    private WorkExceptionA1(String id) {
        this.id = id;
    }
    ...
    public static <V> WorkExceptionA1<V> build(String id, V2PTranslator<V,String> v2PTranslator){
        WorkExceptionA1<V> instance = new WorkExceptionA1<>(id);
